...
/**
 * RabbitMQ Controller - Handles task events from the message queue
 * Uses @Controller decorator so @EventPattern works correctly
 */
@Controller()
export class RabbitMQController {
  ...
  async handleTaskCreated(
    ...
    try {
      ...
      this.logger.log(`Successfully processed ${TaskEvent.TASK_CREATED}`);
    } catch (error) {
  ...
  async handleTaskUpdated(
    ...
    try {
      ...
      this.logger.log(`Successfully processed ${TaskEvent.TASK_UPDATED}`);
    } catch (error) {
  ...
  async handleTaskAssigned(
    ...
    try {
      ...
      this.logger.log(`Successfully processed ${TaskEvent.TASK_ASSIGNED}`);
    } catch (error) {
  ...
  async handleTaskCommented(
    ...
    try {
      ...
      this.logger.log(`Successfully processed ${TaskEvent.TASK_COMMENTED}`);
    } catch (error) {
  ...
  async handleTaskDeleted(
    ...
    try {
      ...
      this.logger.log(`Successfully processed ${TaskEvent.TASK_DELETED}`);
    } catch (error) {
